...
b_tl <- "https://www.brookings.edu/research/chinas-role-in-supplying-critical-minerals-for-the-global-energy-transition-what-could-the-future-hold/"
b_tl_2 <- "https://www.brookings.edu/blog/order-from-chaos/2020/03/19/taiwan-shows-its-mettle-in-coronavirus-crisis-while-the-who-is-mia/"
b_tl_3 <- "https://www.brookings.edu/testimonies/iran-terrorism-and-weapons-of-mass-destruction/"

b_test <- b_pull_tests(b_tl)
b_test

b_test_full <- b_pull_try(b_tl)
b_test_2 <- b_pull_try(b_tl_2)
b_test_3 <- b_pull_try(b_tl_3)
